// Package export provides multi-format serialization of lineage graphs for
// consumption by external tools: CSV adjacency list, YAML, and SQL DDL.
package export
...
// WriteCSV exports the graph as a CSV adjacency list.
// Columns: from,to,transform,comment
...
// WriteYAML exports the graph in a simple YAML-like format (no external dependency).
...
// WriteSQLDDL exports the graph as SQL DDL statements representing the lineage
// as a relational schema (nodes table + edges table + foreign keys).
...
// WriteNodeList exports just the node IDs, one per line, in topological order.
