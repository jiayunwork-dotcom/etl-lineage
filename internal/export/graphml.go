...
// GraphML types for XML serialization.
...
// WriteGraphML exports the lineage graph in GraphML format for use with
// external graph visualization tools (Gephi, yEd, Cytoscape).
...
// WriteGEXF exports a minimal GEXF (Graph Exchange XML Format) for Gephi.
